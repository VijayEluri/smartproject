...
public final class Address {
    ...
    public Address(String street, int zipCode, String complement,
    ...
    public String getComplement() {
        return (complement == null) ? "" : complement;
    }
    ...
    public String toFormatedString() {
        return street + comma + complement + comma + zipCode
                + comma + city + slash + state;
    }

    @Override
    public String toString() {
        return "Address{" + "street=" + street + "zipCode=" + zipCode
                + "complement=" + complement + "city=" + city + "state="
                + state + '}';
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((this.city == null)
                ? (o.getCity() != null) : !this.city.equals(o.getCity())) {
            return false;
        }

        if ((this.state == null)
                ? (o.getState() != null) : !this.state.equals(o.getState())) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + (this.complement != null ? this.complement.hashCode() : 0);
