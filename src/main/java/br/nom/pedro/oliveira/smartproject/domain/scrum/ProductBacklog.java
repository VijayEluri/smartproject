...
public final class ProductBacklog {
    ...
    public void setProjectStories(Set<UserStory> projectStories) {
        if (projectStories != null) {
            this.projectStories.addAll(projectStories);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((this.projectStories != other.projectStories)
                && ((this.projectStories == null) ||!this.projectStories.equals(other.projectStories))) {
            return false;
        }

        if ((this.completedStories != other.completedStories)
                && ((this.completedStories == null) ||!this.completedStories.equals(other.completedStories))) {
            return false;
        }

        if ((this.unfinishedStories != other.unfinishedStories)
                && ((this.unfinishedStories == null) ||!this.unfinishedStories.equals(other.unfinishedStories))) {
            return false;
        }

        if ((this.allProjectSprints != other.allProjectSprints)
                && ((this.allProjectSprints == null) ||!this.allProjectSprints.equals(other.allProjectSprints))) {
            return false;
        }

        if ((this.oldSprints != other.oldSprints)
                && ((this.oldSprints == null) ||!this.oldSprints.equals(other.oldSprints))) {
            return false;
        }

        if ((this.currentSprints != other.currentSprints)
                && ((this.currentSprints == null) ||!this.currentSprints.equals(other.currentSprints))) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        hash = 89 * hash + ((this.project != null)
                            ? this.project.hashCode()
                            : 0);
        hash = 89 * hash + ((this.projectStories != null)
                            ? this.projectStories.hashCode()
                            : 0);
        hash = 89 * hash + ((this.completedStories != null)
                            ? this.completedStories.hashCode()
                            : 0);
        hash = 89 * hash + ((this.unfinishedStories != null)
                            ? this.unfinishedStories.hashCode()
                            : 0);
        hash = 89 * hash + ((this.allProjectSprints != null)
                            ? this.allProjectSprints.hashCode()
                            : 0);
        hash = 89 * hash + ((this.oldSprints != null)
                            ? this.oldSprints.hashCode()
                            : 0);
        hash = 89 * hash + ((this.currentSprints != null)
                            ? this.currentSprints.hashCode()
                            : 0);
    ...
    public String toString() {
        return "ProductBacklog{" + "project=" + project + "projectStories=" + projectStories + "completedStories="
               + completedStories + "unfinishedStories=" + unfinishedStories + "allProjectSprints=" + allProjectSprints
               + "oldSprints=" + oldSprints + "currentSprints=" + currentSprints + '}';
    }
}
